...
function createStream(producer, options = {}) {
    ...
    const enhancedOptions = Object.assign(Object.assign({}, (options.backpressure !== null && {
        backpressure: {
            highWatermark: (_b = (_a = options.backpressure) === null || _a === void 0 ? void 0 : _a.highWatermark) !== null && _b !== void 0 ? _b : 100,
            lowWatermark: (_d = (_c = options.backpressure) === null || _c === void 0 ? void 0 : _c.lowWatermark) !== null && _d !== void 0 ? _d : 20,
